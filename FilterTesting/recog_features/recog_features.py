...
steps:
    load the aligned nifiti file generated by neurosketch_realtime_preprocess.py
    no filter
    load mask data and apply mask
    load behavior data and push the behavior data back for multiple TRs
